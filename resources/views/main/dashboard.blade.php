            ...
            <div class="panel-body">                                    
                <div class="row stacked">
                    ...
                    <div class="col-md-8">                                            
                      ...
                      <div class="col-md-2">
                        <div id="dashboard-map-seles" style="width: 100%; height: 300px"></div>
                    </div>  
    ...
    <div class="common-modal modal fade" id="common-Modal1" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-content">
            <ul class="list-inline item-details">
                <li><a href="{{asset('template/http://themifycloud.com/downloads/janux-premium-responsive-bootstrap-admin-dashboard-template/')}} ">Admin templates</a></li>
                <li><a href="{{asset('template/http://themescloud.org')}}">Bootstrap themes</a></li>
            </ul>
        </div>
    </div>
