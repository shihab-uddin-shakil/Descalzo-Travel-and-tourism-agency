                            ...
                            <div class="listing-carousel  fl-wrap ">
                                ...
                                <div class="slick-slide-item">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="{{route('hotelSingleList')}}"><img src="{{asset('template/images/gal/3.jpg')}}" alt=""></a>
                                ...
                                <div class="slick-slide-item">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="{{route('hotelSingleList')}}"><img src="{{asset('template/images/gal/5.jpg')}}" alt=""></a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="{{asset('template/images/avatar/1.jpg')}}" alt=""></a>
                                                    <span class="avatar-tooltip">Added By  <strong>Alisa Noory</strong></span>
                                                </div>
                                            ...
                                            <div class="geodir-category-content fl-wrap title-sin_item">
                                                <div class="geodir-category-content-title fl-wrap">
                                                    <div class="geodir-category-content-title-item">
                                                        <h3 class="title-sin_map"><a href="{{route('hotelSingleList')}}">Moonlight Hotel</a></h3>
