...
<html lang="en">
    <head>
        ...
        <!--=============== css  ===============-->
        <link type="text/css" rel="stylesheet" href="{{asset('templates/css/reset.css')}}">
        <link type="text/css" rel="stylesheet" href="{{asset('templates/css/plugins.css')}}">
        <link type="text/css" rel="stylesheet" href="{{asset('templates/css/style.css')}}">
        <link type="text/css" rel="stylesheet" href="{{asset('templates/css/color.css')}}">
        <!--=============== favicons ===============-->
    ...
    <body>
                ...
                <div class="content">
                    ...
                    <section class="hero-section" data-scrollax-parent="true" id="sec1">
                        <div class="hero-parallax">
                            <div class="bg"  data-bg=" {{asset('templates/images/bg/22.jpg')}} " data-scrollax="properties: { translateY: '200px' }"></div>
                        ...
                        <div class="container">
                            ...
                            <div class="gallery-items fl-wrap mr-bot spad home-grid">
                                ...
                                <div class="gallery-item">
                                    <div class="grid-item-holder">
                                        <div class="listing-item-grid">
                                            ...
                                            <img  src="{{asset('templates/images/city/7.jpg')}}"   alt="">
                                ...
                                <div class="gallery-item gallery-item-second">
                                    <div class="grid-item-holder">
                                        <div class="listing-item-grid">
                                            <img  src="{{asset('templates/images/city/3.jpg')}}"   alt="">
                                ...
                                <div class="gallery-item">
                                    <div class="grid-item-holder">
                                        <div class="listing-item-grid">
                                            ...
                                            <img  src="{{asset('templates/images/city/2.jpg')}}"   alt="">
                                            <div class="listing-item-cat">
                                ...
                                <div class="gallery-item">
                                    <div class="grid-item-holder">
                                        <div class="listing-item-grid">
                                            ...
                                            <img  src="{{asset('templates/images/city/5.jpg')}}"   alt="">
                                            <div class="listing-item-cat">
                                ...
                                <div class="gallery-item">
                                    <div class="grid-item-holder">
                                        <div class="listing-item-grid">
                                            ...
                                            <img  src="{{asset('templates/images/city/6.jpg')}}"   alt="">
                                            <div class="listing-item-cat">
                            ...
                            <div class="listing-carousel  fl-wrap ">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="listing-single.html"><img src="{{asset('templates/images/gal/8.jpg')}}" alt=""></a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="{{asset('templates/images/avatar/1.jpg')}}" alt=""></a>
                                ...
                                <div class="slick-slide-item">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="listing-single.html"><img src="{{asset('templates/images/gal/4.jpg')}}" alt=""></a>
                                ...
                                <div class="slick-slide-item">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="listing-single.html"><img src="{{asset('templates/images/gal/6.jpg')}}" alt=""></a>
                                ...
                                <div class="slick-slide-item">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="listing-single.html"><img src="{{asset('templates/images/gal/2.jpg')}}" alt=""></a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="{{asset('templates/images/avatar/4.jpg')}}" alt=""></a>
                                ...
                                <div class="slick-slide-item">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="listing-single.html"><img src="{{asset('templates/images/gal/3.jpg')}}" alt=""></a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="{{asset('templates/images/avatar/5.jpg')}}" alt=""></a>
                                ...
                                <div class="slick-slide-item">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="listing-single.html"><img src="{{asset('templates/images/gal/5.jpg')}}" alt=""></a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="{{asset('templates/images/avatar/1.jpg')}}" alt=""></a>
                                                    <span class="avatar-tooltip">Added By  <strong>Alisa Noory</strong></span>
                                                </div>
                    ...
                    <section class="parallax-section" data-scrollax-parent="true">
                        <div class="bg"  data-bg="{{asset('templates/images/bg/2.jpg')}}" data-scrollax="properties: { translateY: '100px' }"></div>
                        <div class="overlay op7"></div>
                        <!--container-->
                        <div class="container">
                            <div class="row">
                                    ...
                                    <div class="light-carousel-wrap fl-wrap">
                                        ...
                                        <div class="light-carousel">
                                            ...
                                            <div class="slick-slide-item">
                                                <div class="hotel-card fl-wrap title-sin_item">
                                                    <div class="geodir-category-img">
                                                        <a href="listing-single.html"><img src="{{asset('templates/images/gal/7.jpg')}}" alt=""></a>
                                            ...
                                            <div class="slick-slide-item">
                                                <div class="hotel-card fl-wrap title-sin_item">
                                                    <div class="geodir-category-img">
                                                        <a href="listing-single.html"><img src="{{asset('templates/images/gal/9.jpg')}}" alt=""></a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="collage-image">
                                        <img src="{{asset('templates/images/api.png')}}" class="main-collage-image" alt="">
                                        <div class="images-collage-title color3-bg">Easy<span>Book</span></div>
                                        <div class="collage-image-min cim_1"><img src="{{asset('templates/images/api/1.jpg')}}" alt=""></div>
                                        <div class="collage-image-min cim_2"><img src="{{asset('templates/images/api/2.jpg')}}" alt=""></div>
                                        <div class="collage-image-min cim_3"><img src="{{asset('templates/images/api/3.jpg')}}" alt=""></div>
                            ...
                            <div class="text-carousel single-carousel fl-wrap">
                                ...
                                <div class="slick-item">
                                    <div class="text-carousel-item">
                                        <div class="popup-avatar"><img src="{{asset('templates/images/avatar/1.jpg')}}" alt=""></div>
                                        <div class="listing-rating card-popup-rainingvis" data-starrating2="5"> </div>
                                ...
                                <div class="slick-item">
                                    <div class="text-carousel-item">
                                        <div class="popup-avatar"><img src="{{asset('templates/images/avatar/2.jpg')}}" alt=""></div>
                                        <div class="listing-rating card-popup-rainingvis" data-starrating2="4"> </div>
                                        <div class="review-owner fl-wrap">Milka Antony  - <span>Happy Client</span></div>
                                        <p> "In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. Lorem ipsum dolor sit amet, conse ctetuer adipiscing elit, sed diam nonu mmy nibh euismod tincidunt ut laoreet dolore magna aliquam erat."</p>
                                        <a href="#" class="testim-link">Via Facebook</a>
                                ...
                                <div class="slick-item">
                                    <div class="text-carousel-item">
                                        <div class="popup-avatar"><img src="{{asset('templates/images/avatar/3.jpg')}}" alt=""></div>
                                        <div class="listing-rating card-popup-rainingvis" data-starrating2="5"> </div>
                                        <div class="review-owner fl-wrap">Milka Antony  - <span>Happy Client</span></div>
                                        <p> "In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. Lorem ipsum dolor sit amet, conse ctetuer adipiscing elit, sed diam nonu mmy nibh euismod tincidunt ut laoreet dolore magna aliquam erat."</p>
                                        <a href="#" class="testim-link">Via Facebook</a>
                                ...
                                <div class="slick-item">
                                    <div class="text-carousel-item">
                                        <div class="popup-avatar"><img src="{{asset('templates/images/avatar/4.jpg')}}" alt=""></div>
                                        <div class="listing-rating card-popup-rainingvis" data-starrating2="5"> </div>
                                        <div class="review-owner fl-wrap">Milka Antony  - <span>Happy Client</span></div>
                                        <p> "In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. Lorem ipsum dolor sit amet, conse ctetuer adipiscing elit, sed diam nonu mmy nibh euismod tincidunt ut laoreet dolore magna aliquam erat."</p>
                                        <a href="#" class="testim-link">Via Facebook</a>
                    ...
                    <!-- section end-->
                    <section class="parallax-section" data-scrollax-parent="true">
                        <div class="bg"  data-bg="{{asset('templates/images/bg/14.jpg')}}" data-scrollax="properties: { translateY: '100px' }"></div>
                        ...
                        <div class="container">
                            ...
                            <div class="row home-posts">
                                <div class="col-md-4">
                                    <article class="card-post">
                                        <div class="card-post-img fl-wrap">
                                            <a href="blog-single.html"><img  src="{{asset('templates/images/all/11.jpg')}}"   alt=""></a>
                                        </div>
                                        <div class="card-post-content fl-wrap">
                                            <h3><a href="blog-single.html">Blog Post Title.</a></h3>
                                            <p>In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. </p>
                                            <div class="post-author"><a href="#"><img src="{{asset('templates/images/avatar/4.jpg')}}" alt=""><span>By , Mery Lynn</span></a></div>
                                            <div class="post-opt">
                                                <ul>
                                ...
                                <div class="col-md-4">
                                    <article class="card-post">
                                            ...
                                            <div class="list-single-main-media fl-wrap">
                                                <div class="single-slider-wrapper fl-wrap">
                                                    <div class="single-slider fl-wrap"  >
                                                        <div class="slick-slide-item"><img src="{{asset('templates/images/all/9.jpg')}}" alt=""></div>
                                                        <div class="slick-slide-item"><img src="{{asset('templates/images/all/7.jpg')}}" alt=""></div>
                                                        <div class="slick-slide-item"><img src="{{asset('templates/images/all/1.jpg')}}" alt=""></div>
                                                    </div>
                                                    <div class="swiper-button-prev sw-btn"><i class="fa fa-long-arrow-left"></i></div>
                                                    <div class="swiper-button-next sw-btn"><i class="fa fa-long-arrow-right"></i></div>
                                                </div>
                                        ...
                                        <div class="card-post-content fl-wrap">
                                            <h3><a href="blog-single.html">Blog Post Title.</a></h3>
                                            <p>In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. </p>
                                            <div class="post-author"><a href="#"><img src="{{asset('templates/images/avatar/1.jpg')}}" alt=""><span>By , Mery Lynn</span></a></div>
                                            <div class="post-opt">
                                                <ul>
                                                    <li><i class="fal fa-calendar"></i> <span>25 April 2018</span></li>
                                                    <li><i class="fal fa-eye"></i> <span>264</span></li>
                                ...
                                <div class="col-md-4">
                                    <article class="card-post">
                                        <div class="card-post-img fl-wrap">
                                            <a href="blog-single.html"><img  src="{{asset('templates/images/all/10.jpg')}}"   alt=""></a>
                                        </div>
                                        <div class="card-post-content fl-wrap">
                                            <h3><a href="blog-single.html">Blog Post Title.</a></h3>
                                            <p>In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. </p>
                                    ...
                                    <div class="footer-carousel-wrap fl-wrap">
                                        <div class="footer-carousel fl-wrap">
                                            ...
                                            <div class="footer-carousel-item">
                                                <a href="#"><img src="{{asset('templates/images/partners/1.png')}}" alt=""></a>
                                            </div>
                                            <!--footer-carousel-item end-->
                                            <!--footer-carousel-item-->
                                            <div class="footer-carousel-item">
                                                <a href="#"><img src="{{asset('templates/images/partners/2.png')}}" alt=""></a>
                                            </div>
                                            <!--footer-carousel-item end-->
                                            <!--footer-carousel-item-->
                                            <div class="footer-carousel-item">
                                                <a href="#"><img src="{{asset('templates/images/partners/3.png')}}" alt=""></a>
                                            </div>
                                            <!--footer-carousel-item end-->
                                            <!--footer-carousel-item-->
                                            <div class="footer-carousel-item">
                                                <a href="#"><img src="{{asset('templates/images/partners/4.png')}}" alt=""></a>
                                            </div>
                                            <!--footer-carousel-item end-->
                                            <!--footer-carousel-item-->
                                            <div class="footer-carousel-item">
                                                <a href="#"><img src="{{asset('templates/images/partners/5.png')}}" alt=""></a>
                                            </div>
                                            <!--footer-carousel-item end-->
                                            <!--footer-carousel-item-->
                                            <div class="footer-carousel-item">
                                                <a href="#"><img src="{{asset('templates/images/partners/6.png')}}" alt=""></a>
                                            </div>
                                            <!--footer-carousel-item end-->
                                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="footer-widget fl-wrap">
                                    ...
                                    <div class="widget-posts fl-wrap">
                                        <ul>
                                            <li class="clearfix">
                                                <a href="#"  class="widget-posts-img"><img src="{{asset('templates/images/all/1.jpg')}}" class="respimg" alt=""></a>
                                                <div class="widget-posts-descr">
                                            ...
                                            <li class="clearfix">
                                                <a href="#"  class="widget-posts-img"><img src="{{asset('templates/images/all/2.jpg')}}" class="respimg" alt=""></a>
                                                <div class="widget-posts-descr">
                                            ...
                                            <li class="clearfix">
                                                <a href="#"  class="widget-posts-img"><img src="{{asset('templates/images/all/3.jpg')}}" class="respimg" alt=""></a>
                                                <div class="widget-posts-descr">
        ...
        <script type="text/javascript" src="{{asset('templates/js/plugins.js')}}"></script>
        <script type="text/javascript" src="{{asset('templates/js/scripts.js')}}"></script>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDwJSRi0zFjDemECmFl9JtRj1FY7TiTRRo&libraries=places&callback=initAutocomplete"></script>
        <script type="text/javascript" src="{{asset('templates/js/map-single.js')}}"></script>
    </body>
</html>