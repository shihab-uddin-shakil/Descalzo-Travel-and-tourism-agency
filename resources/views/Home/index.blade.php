...
<head>
    ...
    <!--=============== css  ===============-->
    <link type="text/css" rel="stylesheet" href="{{ asset('template2/css/reset.css') }}">
    <link type="text/css" rel="stylesheet" href="{{ asset('template2/css/plugins.css') }}">
    <link type="text/css" rel="stylesheet" href="{{ asset('template2/css/style.css') }}">
    <link type="text/css" rel="stylesheet" href="{{ asset('template2/css/color.css') }}">
    <!--=============== favicons ===============-->
    <link rel="shortcut icon" href="{{ asset('template2/images/favicon.ico') }}">
</head>
...
<body>
            ...
            <div class="header-top fl-wrap">
                <div class="container">
                    <div class="logo-holder">
                        <a href="index.html"><img src="{{ asset('template2/images/logo.png') }}" alt=""></a>
                    </div>
                    <a href="dashboard-add-listing.html" class="add-hotel">Add Your Hotel <span><i
                                class="far fa-plus"></i></span></a>
                    <div class="show-reg-form modal-open"><i class="fa fa-sign-in"></i>Sign In</div>
                    <div class="lang-wrap">
                        <div class="show-lang"><img src="{{ asset('template2/images/lan/1.png') }}" alt=""> <span>Eng</span><i
                                class="fa fa-caret-down"></i></div>
                        <ul class="lang-tooltip green-bg">
                            <li><a href="#"><img src="{{ asset('template2/images/lan/4.png') }}" alt=""> De</a></li>
                            <li><a href="#"><img src="{{ asset('template2/images/lan/5.png') }}" alt=""> It</a></li>
                            <li><a href="#"><img src="{{ asset('template2/images/lan/2.png') }}" alt=""> Fr</a></li>
                            <li><a href="#"><img src="{{ asset('template2/images/lan/3.png') }}" alt=""> Es</a></li>
                        </ul>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="header-user-menu">
                        <div class="header-user-name">
                            <span><img src="{{ asset('template2/images/avatar/4.jpg') }}" alt=""></span>
                            My account
                        </div>
                        <ul>
                    ...
                    <div class="wishlist-wrap scrollbar-inner novis_wishlist">
                        <div class="box-widget-content">
                            <div class="widget-posts fl-wrap">
                                <ul>
                                    <li class="clearfix">
                                        <a href="#" class="widget-posts-img"><img src="{{ asset('template2/images/gal/7.jpg') }}" class="respimg"
                                                alt=""></a>
                                    ...
                                    <li class="clearfix">
                                        <a href="#" class="widget-posts-img"><img src="{{ asset('template2/images/gal/8.jpg') }}" class="respimg"
                                                alt=""></a>
                                        <div class="widget-posts-descr">
                                    ...
                                    <li class="clearfix">
                                        <a href="#" class="widget-posts-img"><img src="{{ asset('template2/images/gal/9.jpg') }}" class="respimg"
                                                alt=""></a>
                                        <div class="widget-posts-descr">
            ...
            <div class="content">
                ...
                <section class="hero-section" data-scrollax-parent="true" id="sec1">
                    <div class="hero-parallax">
                        <div class="bg" data-bg="images/bg/22.jpg" data-scrollax="properties: { translateY: '200px' }">
                        </div>
                            ...
                            <div class="main-search-input-wrap">
                                <div class="main-search-input fl-wrap">
                                    ...
                                    <div class="main-search-input-item main-date-parent main-search-input-item_small">
                                        <span class="inpt_dec"><i class="fal fa-calendar-check"></i></span> <input
                                            type="text" placeholder="When" name="main-input-search" value="" />
                                    </div>
                                    <div class="main-search-input-item">
                                        <div class="qty-dropdown fl-wrap">
                                            <div class="qty-dropdown-header fl-wrap"><i class="fal fa-users"></i>
                                                Persons</div>
                ...
                <section id="sec2">
                    ...
                    <div class="gallery-items fl-wrap mr-bot spad home-grid">
                        ...
                        <div class="gallery-item">
                            <div class="grid-item-holder">
                                <div class="listing-item-grid">
                                    ...
                                    <img src="{{ asset('template2/images/city/7.jpg') }}" alt="">
                        ...
                        <div class="gallery-item gallery-item-second">
                            <div class="grid-item-holder">
                                <div class="listing-item-grid">
                                    <img src="{{ asset('template2/images/city/3.jpg') }}" alt="">
                        ...
                        <div class="gallery-item">
                            <div class="grid-item-holder">
                                <div class="listing-item-grid">
                                    ...
                                    <img src="{{ asset('template2/images/city/2.jpg') }}" alt="">
                                    <div class="listing-item-cat">
                        ...
                        <div class="gallery-item">
                            <div class="grid-item-holder">
                                <div class="listing-item-grid">
                                    ...
                                    <img src="{{ asset('template2/images/city/5.jpg') }}" alt="">
                                    <div class="listing-item-cat">
                        ...
                        <div class="gallery-item">
                            <div class="grid-item-holder">
                                <div class="listing-item-grid">
                                    ...
                                    <img src="{{ asset('template2/images/city/6.jpg') }}" alt="">
                                    <div class="listing-item-cat">
                    ...
                    <!-- portfolio end -->
                    <a href="listing.html" class="btn    color-bg">Explore All Cities<i
                        ...
                        <div class="listing-carousel  fl-wrap ">
                                ...
                                <div class="listing-item">
                                    <article class="geodir-category-listing fl-wrap">
                                        <div class="geodir-category-img">
                                            <a href="listing-single.html"><img src="{{ asset('template2/images/gal/8.jpg') }}" alt=""></a>
                                            <div class="listing-avatar"><a href="author-single.html"><img
                                                        src="{{ asset('template2/images/avatar/1.jpg') }}" alt=""></a>
                            ...
                            <div class="slick-slide-item">
                                ...
                                <div class="listing-item">
                                    <article class="geodir-category-listing fl-wrap">
                                        <div class="geodir-category-img">
                                            {{--  <a href="listing-single.html"><img src="{{ asset('template2/images/gal/4.jpg') }}" alt=""></a>  --}}
                                            <div class="listing-avatar"><a href="author-single.html"><img
                                                        {{--  src="{{ asset('template2/images/avatar/2.jpg') }}" alt=""></a>  --}}
                            ...
                            <div class="slick-slide-item">
                                ...
                                <div class="listing-item">
                                    <article class="geodir-category-listing fl-wrap">
                                        <div class="geodir-category-img">
                                            {{--  <a href="listing-single.html"><img src="{{ asset('template2/images/gal/6.jpg') }}" alt=""></a>  --}}
                                            <div class="listing-avatar"><a href="author-single.html"><img
                                                        src="{{ asset('template2/images/avatar/3.jpg') }}" alt=""></a>
                            ...
                            <div class="slick-slide-item">
                                ...
                                <div class="listing-item">
                                    <article class="geodir-category-listing fl-wrap">
                                        <div class="geodir-category-img">
                                            <a href="listing-single.html"><img src="{{ asset('template2/images/gal/2.jpg') }}" alt=""></a>
                                            <div class="listing-avatar"><a href="author-single.html"><img
                                                        src="{{ asset('template2/images/avatar/4.jpg') }}" alt=""></a>
                            ...
                            <div class="slick-slide-item">
                                ...
                                <div class="listing-item">
                                    <article class="geodir-category-listing fl-wrap">
                                        <div class="geodir-category-img">
                                            <a href="listing-single.html"><img src="{{ asset('template2/images/gal/3.jpg" alt=""></a>
                                            <div class="listing-avatar"><a href="author-single.html"><img
                                                        {{--  src="{{ asset('template2/images/avatar/5.jpg') }}" alt=""></a>  --}}
                            ...
                            <div class="slick-slide-item">
                                ...
                                <div class="listing-item">
                                    <article class="geodir-category-listing fl-wrap">
                                        <div class="geodir-category-img">
                                            <a href="listing-single.html"><img src="{{ asset('template2/images/gal/5.jpg') }}" alt=""></a>
                                            <div class="listing-avatar"><a href="author-single.html"><img
                                                        src="{{ asset('template2/images/avatar/1.jpg') }}" alt=""></a>
                                                <span class="avatar-tooltip">Added By <strong>Alisa
                                                        Noory</strong></span>
                            ...
                            <div class="col-md-4">
                                <div class="colomn-text fl-wrap pad-top-column-text_small">
                                    <div class="colomn-text-title">
                                        ...
                                        <a href="listing.html" class="btn  color2-bg float-btn">View All Hotels<i
                                                class="fas fa-caret-right"></i></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="light-carousel-wrap fl-wrap">
                                    ...
                                    <div class="light-carousel">
                                        ...
                                        <div class="slick-slide-item">
                                            <div class="hotel-card fl-wrap title-sin_item">
                                                <div class="geodir-category-img card-post">
                                                    <a href="listing-single.html"><img src="{{ asset('template2/images/gal/8.jpg') }}"
                                                            alt=""></a>
                                        ...
                                        <div class="slick-slide-item">
                                            <div class="hotel-card fl-wrap title-sin_item">
                                                <div class="geodir-category-img">
                                                    <a href="listing-single.html"><img src="{{ asset('template2/images/gal/7.jpg') }}"
                                                            alt=""></a>
                                                    ...
                                                    <div class="geodir-category-opt">
                                                        ...
                                                        <h4 class="title-sin_map"><a href="listing-single.html">Holiday
                                                                Home</a></h4>
                                                        <div class="geodir-category-location"><a href="#"
                                                                class="single-map-item" data-newlatitude="40.72228267"
                                                                data-newlongitude="-73.99246214"><i
                                                                    class="fas fa-map-marker-alt"></i> 34-42 Montgomery
                                                                St , NY, USA</a></div>
                                                        <div class="rate-class-name">
                                        ...
                                        <div class="slick-slide-item">
                                            <div class="hotel-card fl-wrap title-sin_item">
                                                <div class="geodir-category-img">
                                                    <a href="listing-single.html"><img src="{{ asset('template2/images/gal/9.jpg') }}"
                                                            alt=""></a>
                                                    ...
                                                    <div class="geodir-category-opt">
                                                        ...
                                                        <h4 class="title-sin_map"><a href="listing-single.html">Grand
                                                                Hero Palace</a></h4>
                                                        <div class="geodir-category-location"><a href="#"
                                                                class="single-map-item" data-newlatitude="40.76221766"
                                                                data-newlongitude="-73.96511769"><i
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="colomn-text  pad-top-column-text fl-wrap">
                                    <div class="colomn-text-title">
                                        ...
                                        <a href="#" class=" down-btn color3-bg"><i class="fab fa-apple"></i> Download
                                            for iPhone</a>
                                        <a href="#" class=" down-btn color3-bg"><i class="fab fa-android"></i> Download
                                            for Android</a>
                                    </div>
                                </div>
                                <!--process-wrap   end-->
                            ...
                            <div class="col-md-6">
                                <div class="collage-image">
                                    ...
                                    <div class="collage-image-min cim_1"><img src="{{ asset('template2/images/api/1.jpg') }}" alt=""></div>
                                    <div class="collage-image-min cim_2"><img src="{{ asset('template2/images/api/2.jpg') }}" alt=""></div>
                                    <div class="collage-image-min cim_3"><img src="{{ asset('template2/images/api/3.jpg') }}" alt=""></div>
                        ...
                        <div class="text-carousel single-carousel fl-wrap">
                            ...
                            <div class="slick-item">
                                <div class="text-carousel-item">
                                    <div class="popup-avatar"><img src="{{ asset('template2/images/avatar/1.jpg') }}" alt=""></div>
                            ...
                            <div class="slick-item">
                                <div class="text-carousel-item">
                                    <div class="popup-avatar"><img src="{{ asset('template2/images/avatar/2.jpg') }}" alt=""></div>
                            ...
                            <div class="slick-item">
                                <div class="text-carousel-item">
                                    <div class="popup-avatar"><img src="{{ asset('template2/images/avatar/3.jpg') }}" alt=""></div>
                                    <div class="listing-rating card-popup-rainingvis" data-starrating2="5"> </div>
                                    <div class="review-owner fl-wrap">Milka Antony - <span>Happy Client</span></div>
                                    <p> "In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis
                                        cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. Lorem ipsum dolor sit
                            ...
                            <div class="slick-item">
                                <div class="text-carousel-item">
                                    <div class="popup-avatar"><img src="{{ asset('template2/images/avatar/4.jpg') }}" alt=""></div>
                                    <div class="listing-rating card-popup-rainingvis" data-starrating2="5"> </div>
                                    <div class="review-owner fl-wrap">Milka Antony - <span>Happy Client</span></div>
                                    <p> "In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis
                                        cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. Lorem ipsum dolor sit
                ...
                <!-- section end-->
                <section class="parallax-section" data-scrollax-parent="true">
                    <div class="bg" data-bg="images/bg/14.jpg" data-scrollax="properties: { translateY: '100px' }">
                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row home-posts">
                            <div class="col-md-4">
                                <article class="card-post">
                                    <div class="card-post-img fl-wrap">
                                        <a href="blog-single.html"><img src="{{ asset('template2/images/all/11.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="card-post-content fl-wrap">
                                        <h3><a href="blog-single.html">Blog Post Title.</a></h3>
                                        <p>In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis
                                            cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. </p>
                                        <div class="post-author"><a href="#"><img src="{{ asset('template2/images/avatar/4.jpg') }}"
                            ...
                            <div class="col-md-4">
                                <article class="card-post">
                                        ...
                                        <div class="list-single-main-media fl-wrap">
                                            <div class="single-slider-wrapper fl-wrap">
                                                <div class="single-slider fl-wrap">
                                                    <div class="slick-slide-item"><img src="{{ asset('template2/images/all/9.jpg') }}" alt="">
                                                    </div>
                                                    <div class="slick-slide-item"><img src="{{ asset('template2/images/all/7.jpg') }}" alt="">
                                                    </div>
                                                    <div class="slick-slide-item"><img src="{{ asset('template2/images/all/1.jpg') }}" alt="">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-post-content fl-wrap">
                                        ...
                                        <p>In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis
                                            cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. </p>
                                        <div class="post-author"><a href="#"><img src="{{ asset('template2/images/avatar/1.jpg') }}"
                                                    alt=""><span>By , Mery Lynn</span></a></div>
                                        <div class="post-opt">
                                            <ul>
                                                <li><i class="fal fa-calendar"></i> <span>25 April 2018</span></li>
                            ...
                            <div class="col-md-4">
                                <article class="card-post">
                                    <div class="card-post-img fl-wrap">
                                        <a href="blog-single.html"><img src="{{ asset('template2/images/all/10.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="card-post-content fl-wrap">
                                        <h3><a href="blog-single.html">Blog Post Title.</a></h3>
                                        <p>In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis
            ...
            <div class="footer-inner">
                <div class="container">
                                ...
                                <div class="footer-carousel-wrap fl-wrap">
                                    <div class="footer-carousel fl-wrap">
                                        ...
                                        <div class="footer-carousel-item">
                                            <a href="#"><img src="{{ asset('template2/images/partners/1.png') }}" alt=""></a>
                                        </div>
                                        <!--footer-carousel-item end-->
                                        <!--footer-carousel-item-->
                                        <div class="footer-carousel-item">
                                            <a href="#"><img src="{{ asset('template2/images/partners/2.png') }}" alt=""></a>
                                        </div>
                                        <!--footer-carousel-item end-->
                                        <!--footer-carousel-item-->
                                        <div class="footer-carousel-item">
                                            <a href="#"><img src="{{ asset('template2/images/partners/3.png') }}" alt=""></a>
                                        </div>
                                        <!--footer-carousel-item end-->
                                        <!--footer-carousel-item-->
                                        <div class="footer-carousel-item">
                                            <a href="#"><img src="{{ asset('template2/images/partners/4.png') }}" alt=""></a>
                                        </div>
                                        <!--footer-carousel-item end-->
                                        <!--footer-carousel-item-->
                                        <div class="footer-carousel-item">
                                            <a href="#"><img src="{{ asset('template2/images/partners/5.png') }}" alt=""></a>
                                        </div>
                                        <!--footer-carousel-item end-->
                                        <!--footer-carousel-item-->
                                        <div class="footer-carousel-item">
                                            <a href="#"><img src="{{ asset('template2/images/partners/6.png') }}" alt=""></a>
                                        </div>
                                        <!--footer-carousel-item end-->
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="footer-widget fl-wrap">
                                ...
                                <div class="widget-posts fl-wrap">
                                    <ul>
                                        <li class="clearfix">
                                            <a href="#" class="widget-posts-img"><img src="{{ asset('template2/images/all/1.jpg') }}"
                                                    class="respimg" alt=""></a>
                                            <div class="widget-posts-descr">
                                        ...
                                        <li class="clearfix">
                                            <a href="#" class="widget-posts-img"><img src="{{ asset('template2/images/all/2.jpg') }}"
                                                    class="respimg" alt=""></a>
                                            <div class="widget-posts-descr">
                                        ...
                                        <li class="clearfix">
                                            <a href="#" class="widget-posts-img"><img src="{{ asset('template2/images/all/3.jpg') }}"
                                                    class="respimg" alt=""></a>
                                            <div class="widget-posts-descr">
                    ...
                    <div class="footer-widget">
                        <div class="row">
                            <div class="col-md-4"><a class="contact-btn color-bg" href="contacts.html">Get In Touch<i
        ...
        <div class="main-register-wrap modal">
            ...
            <div class="main-register-holder">
                <div class="main-register fl-wrap">
                    ...
                    <ul class="tabs-menu">
                        <li class="current"><a href="{{ url('/Login') }}"><i class="fal fa-sign-in-alt"></i> Login</a>
                        </li>
    ...
    <!-- Main end -->
    <!--=============== scripts  ===============-->
    <script type="text/javascript" src="{{ asset('template2/js/jquery.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('template2/js/plugins.js') }}"></script>
    <script type="text/javascript" src="{{ asset('template2/js/scripts.js') }}"></script>
    <script
